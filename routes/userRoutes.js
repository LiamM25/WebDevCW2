...
router.get('/userDonate', verify, checkUserSession, userController.renderUserDonatePage);
router.get('/userContact', verify, checkUserSession, userController.renderUserContactPage);
